...
function WatermarkComponent({ watermarkImageSrc, screenshotDataURI }) {
  ...
  useEffect(() => {
    ...
    img.onload = () => {
      ...
      // Draw the watermark image onto the main canvas
      watermarkImage.onload = () => {
        const x = 340;
        const y = img.height - 190;
        const width = 50;
        const height = 50;
  ...
  }, [screenshotDataURI, watermarkImageSrc]);
...
function App() {
  ...
  const watermarkImageSrc = <img src="logo192.png" alt="img" />;
  ...
  return (
    <div className="App">
      ...
      <WatermarkComponent
        watermarkImageSrc={watermarkImageSrc.props.src}
